...
class Weapon:
    ...
    def __init__(self, name, damage_type, range=1, die_max_value=1, number_of_dice=0, damage=0, crit_chance=1,
                 multiplier_crit=2, add_to_list=True):
        self.name = name
...
class WeaponList:
    ...
    unarmed = Weapon(name='unarmed', number_of_dice=0, die_max_value=0, damage=1, damage_type='bludgeoning', range=1, add_to_list=False)
